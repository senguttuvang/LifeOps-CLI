...
const mockMessages: MessageForSignals[] = [
  ...
  {
    id: "3",
    text: "Aw that sucks babe. Want to talk? ❤️",
    fromMe: true,
...
const mockSignals: UserSignals = {
  ...
  periodRate: 0.2,
  ellipsisRate: 0.1,
  commonGreetings: ["hey babe", "hey love"],
...
describe("Prompt Builder", () => {
  ...
  it("should build basic prompt without signals", () => {
    const prompt = buildBasicPrompt("I had a terrible day", ["That sucks babe"]);

    expect(prompt).toContain("I had a terrible day");
    expect(prompt).toContain("That sucks babe");
  });
});

describe("Signal Enforcer", () => {
  it("should enforce emoji count", () => {
    const draft = "Aw that sucks babe"; // 0 emojis
  ...
  it("should add follow-up question when required", () => {
    ...
    const draft = "That sucks babe"; // No question
  ...
  it("should validate draft against signals", () => {
    const goodDraft = "That sucks babe! Want to talk? ❤️"; // Matches signals well
...
describe("Quality Scorer", () => {
  it("should score draft quality", () => {
    const draft = "That sucks babe! Want to talk? ❤️";
  ...
  it("should assign higher scores to better-matching drafts", () => {
    const goodDraft = "That sucks babe! Want to talk? ❤️"; // Matches signals
  ...
  it("should compare drafts and identify winner", () => {
    ...
    const signalDraft = "That sucks babe! Want to talk? ❤️";
...
describe("Integration Test", () => {
  it("should complete full signal extraction -> enforcement -> scoring flow", () => {
    ...
    const simulatedDraft = "That sucks! Want to talk?";
