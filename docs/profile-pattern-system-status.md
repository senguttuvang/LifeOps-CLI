...
Step 4: AI generates draft
  → "Hey babe, I'm running a bit late. Traffic is crazy. Be there in 20!"
...
**NO understanding of**:
1. **User persona**: Is user formal vs casual? Direct vs apologetic? Uses "babe" vs "love" vs name?
...
Step 4: Generate draft with profile awareness
  ...
  → Use user's preferred term ("love" not "babe")
