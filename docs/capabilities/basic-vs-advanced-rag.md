...
// Output: "Aw that sucks babe! What happened? I'm here if you need to talk ❤️"
```

### What It Learns ✅

1. **Vocabulary**:
   - User says "babe" not "honey"
...
3. **Response Patterns**:
   - Acknowledges emotion ("that sucks")
   - Asks what happened
...
const userSignals = {
  ...
  preferredGreeting: ["hey babe", "hey love"],
  preferredEnding: ["❤️", "😘"],
...
- Greeting: "hey babe" or "hey love"
- Common phrases: "that sucks", "want to talk about it"
...
// Output: "Hey love, that sucks! What happened? Want to talk? ❤️"
...
```
"Aw that sucks babe! What happened at work? I'm here if you need
to talk ❤️"

✅ Matches vocabulary ("sucks", "babe")
✅ Casual tone
✅ Ends with ❤️
...
```
"Hey love, that sucks! What happened? Want to talk? ❤️"
...
[30 seconds]
Self-DM: "Aw that sucks babe! What happened? I'm here ❤️"
...
Girlfriend: "I had the worst day"
[30 seconds]
Self-DM: "Hey love, that sucks! What happened? Want to talk? ❤️"
