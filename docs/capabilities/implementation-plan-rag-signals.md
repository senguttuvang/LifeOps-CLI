...
Draft: "Aw that sucks babe! What happened? I'm here if you need to talk ❤️"

Matches:
✅ Vocabulary ("sucks", "babe")
✅ Casual tone
✅ Generic pattern
...
Draft: "Aw that sucks babe! What happened? Want to talk? ❤️"
...
CREATE TABLE user_signals (
  ...
  -- Common patterns
  common_greetings TEXT,            -- JSON: ["hey babe", "hey love", ...]
