...
export const contacts = sqliteTable("contacts", {
  ...
  type: text("type", { enum: ["person", "business", "group"] })
    .notNull()
    .default("person"),
...
export const conversations = sqliteTable(
  ...
  (table) => ({
    sourceConversationIdx: index("idx_conversations_source_conversation").on(table.source, table.sourceConversationId),
...
export const interactions = sqliteTable(
  ...
  (table) => ({
    ...
    sourceInteractionIdx: index("idx_interactions_source_interaction").on(table.source, table.sourceInteractionId),
  }),
);
...
export const locationShares = sqliteTable("location_shares", {
  ...
  sharedByContactId: text("shared_by_contact_id")
    .notNull()
    .references(() => contacts.id),
});
...
export const polls = sqliteTable("polls", {
  ...
  createdByContactId: text("created_by_contact_id")
    .notNull()
    .references(() => contacts.id),
});
...
export const pollVotes = sqliteTable(
  "poll_votes",
  {
    ...
    voterContactId: text("voter_contact_id")
      .notNull()
      .references(() => contacts.id),
